...
@section('title','Ecommerce Site || Brand-Form')
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body px-0 pb-0">
                        <div class="card-body">
                            @isset($data)
                            {{ Form::open(['url'=>route('brand.update',$data->id),'files'=>true,'class'=>'form form-horizontal'])}}
                                @method('put')
                            @else
                            {{ Form::open(['url'=>route('brand.store'),'files'=>true,'class'=>'form form-horizontal'])}}
                            @endisset
                                <div class="form-body">
                                    <div class="row">
                                    ...
                                    <div class="col-md-10 form-group">
                                        {{ Form::text('title',@$data->title,['class'=>'form-control form-control-sm '.($errors->has('title') ?'is-invalid':''),'required'=>true,'placeholder'=>'Enter Brand Title Here......'])}}
                                        @error('title')
                                    ...
                                    @isset($data)
                                        <div class="col-md-4">
                                            <img src="{{ asset('Uploads/Brand/'.@$data->image) }}" alt="" class="img-fluid img-thumbnail">
                                        </div>
                                    @endisset
